// TODO: confirm answers marked TBA with e-board before launch.
const faq = [
  {
  ...
  {
    q: 'Who can attend?',
    a: 'The event is aimed at USC students. Exact eligibility details (including whether virtual participation is open beyond USC) will be confirmed when registration opens.',
  },
  {
  ...
  {
    q: 'How do teams work?',
    a: 'Team guidelines (size, formation, solo participation) will be announced alongside the challenges.',
  },
  {
    q: 'Will there be prizes?',
    a: 'Prize details are being finalized and will be posted here once locked in.',
  },
  {
    q: 'How do I sign up?',
